    ...
    protected Map<String,String> doInBackground(String... urls) {
        ...
        try {
            ...
            try {
                ...
                Log.d("CryptoHealthLog", "Credentials Object saved");
            } catch (IOException e) {
                e.printStackTrace();
                Log.d("CryptoHealthLog", "Error while saving credentials object to internal storage : " + e.getMessage());
            }
            ...
            Log.d("CryptoHealthLog", "Transaction Hash : " + transHash);
            ...
            context.sendBroadcast(intent);
                ...
                Log.d("CryptoHealthLog", "Error while initalizing Eth account  : " + e.getMessage() + " || " + e.toString());
                e.printStackTrace();
            }
        return resMap ;
    }
